...
_wrap_con_ic_connection_connect(PyGObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs,"O:ConIcConnection.request_connect", kwlist, &py_flags))
        return NULL;
...
static const PyMethodDef _PyConIcConnection_methods[] = {
    { "request_connect", (PyCFunction)_wrap_con_ic_connection_connect, METH_VARARGS|METH_KEYWORDS,
      NULL },
